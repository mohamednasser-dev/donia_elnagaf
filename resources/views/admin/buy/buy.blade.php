                                ...
                                <div class="card-block">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="table-responsive">
                                            <table id="search_table" class="table full-color-table full-warning-table">
                                                <thead>
                                                <tr>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td class="text-lg-center">{{trans('admin.sale_total')}}</td>
                                            <td class="text-lg-center"><input type="text" style="width: 100px;"
                                                                                                   name="total"
                                                                                                   id="lbl_total"
                                        ...
                                        @if(auth()->user()->type == 'admin')
                                            <tr>
                                                <td class="text-lg-center">الخصم</td>
                                                <td class="text-lg-center">
                                                    {!! Form::number('khasm',$customer_bills_selected->khasm,['style'=>"width: 100px;",'class'=>'form-control center','step' =>'0.01','id' =>'txt_khasm','max'=>$customer_bills_selected->total,'min'=>'0' ]) !!}</td>
                                            </tr>
                                        @endif
                                        <tr>
                                            <td class="text-lg-center">{{trans('admin.sale_pay')}}</td>
                                            <td class="text-lg-center">{!! Form::number('pay',$customer_bills_selected->pay,['style'=>"width: 100px;",'class'=>'form-control center','step' =>'0.01','id' =>'txt_pay','max'=>$customer_bills_selected->total,'min'=>'0' ]) !!}</td>
                                        </tr>
                                        <tr>
                                            <td class="text-lg-center">{{trans('admin.sale_remain')}}</td>
                                            <td class="text-lg-center"><input id="lbl_remain"
                                                                                               name="remain" style="width: 100px;"
                                                                                               type="text"
                                                                                               class='form-control center'

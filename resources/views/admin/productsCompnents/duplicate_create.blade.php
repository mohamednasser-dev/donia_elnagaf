            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group m-t-40 row">
                        ...
                        <div class="col-md-10">
                            {{ Form::text('name',$basic_product->name,["class"=>"form-control" ,"required",'placeholder'=>trans('admin.name')]) }}
                        </div>
                    </div>
                    <div class="form-group m-t-40 row">
                        <label for="example-text-input"
                        ...
                        <div class="col-md-10">
                            {{ Form::number('barcode',$basic_product->barcode,["class"=>"form-control" ,"required",'placeholder'=>trans('admin.barcode')]) }}
                    ...
                    <div class="form-group m-t-40 row">
                        ...
                        <div class="col-md-10">
                            {{ Form::number('gomla_price',$basic_product->gomla_price,["class"=>"form-control" ,"required",'placeholder'=>trans('admin.gomla_price')]) }}
                        </div>
                    </div>
                    <div class="form-group m-t-40 row">
                        <label for="example-text-input"
                        ...
                        <div class="col-md-10">
                            {{ Form::number('selling_price',$basic_product->selling_price,["class"=>"form-control" ,"required",'placeholder'=>trans('admin.buy_price')]) }}
                        </div>
                    </div>
                    <div class="form-group m-t-40 row">
                        <label for="example-text-input"

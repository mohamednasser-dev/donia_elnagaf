...
{{--                    <div class="card">--}}
{{--                        <div class="card-body">--}}
{{--                            <h4 class="card-title">صورة اللوجو الموقع الخارجي</h4>--}}
...
{{--                    <div class="card">--}}
{{--                        <div class="card-body">--}}
{{--                            <h4 class="card-title">صورة اللوجو الموقع الداخلي</h4>--}}
{{--                            <input type="file" name="home_logo" id="input-file-now" class="dropify"/>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
